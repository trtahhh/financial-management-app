...
public class UserController {
 ...
 .body(Collections.singletonMap("error", "Cannot extract userId from token"));
 }
 ...
 response.put("fullName", profile != null ? profile.getFullName() : user.getUsername());
 response.put("email", user.getEmail());
 response.put("phone", profile != null ? profile.getPhone() : null);
 response.put("birthDate", profile != null ? profile.getBirthday() : null);
 response.put("gender", profile != null ? profile.getGender() : null);
 response.put("address", profile != null ? profile.getAddress() : null);
 response.put("role", user.getRole());
 response.put("avatarUrl", profile != null ? profile.getImageUrl() : null);
 
 if (profile != null) {
 response.put("profile", profile);
 }
 
 log.info("Profile data retrieved successfully for user: {}", userId);
 ...
 if (userId == null) {
 return ResponseEntity.badRequest().body(Collections.singletonMap("error", "Cannot extract userId"));
 }
 ...
 response.put("avatarUrl", "/uploads/" + filename);
 return ResponseEntity.ok(response);
 } catch (Exception e) {
