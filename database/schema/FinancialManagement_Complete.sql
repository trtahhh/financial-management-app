...
-- Unified script with email verification, initial balance, and optimized indexes
-- ========================================
...
CREATE INDEX IX_Transactions_user_category_month ON Transactions(user_id, category_id, month(trans_date), year(trans_date));
CREATE INDEX IX_Transactions_user_type_date ON Transactions(user_id, type, trans_date);
...
(2, 6, 8, 2024, 800000),    -- Entertainment budget
